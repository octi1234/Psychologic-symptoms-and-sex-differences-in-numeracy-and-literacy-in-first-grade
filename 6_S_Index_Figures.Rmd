...
test$agedev<-scale(test$agedev)
test$mcascore<-scale(test$mcascore)
```
...
```{r}
s.index (test$agedev[test$sex=="Boys"],test$agedev[test$sex=="Girls"], xlab = "Developmental age at 5.5 years old", group.labels = c("Boys","Girls"))
```
